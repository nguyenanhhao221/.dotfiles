# Generated by Powerlevel10k configuration wizard on 2025-06-11 at 22:02 +07.
...
() {
  ...
  function my_git_formatter() {
    ...
    # *42 if have stashes. #Comment out to disable
  ...
  # Custom icon.
	typeset -g POWERLEVEL9K_VIRTUALENV_VISUAL_IDENTIFIER_EXPANSION='Python'
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_GO_VERSION_VISUAL_IDENTIFIER_EXPANSION='GoLang'
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_LUAENV_VISUAL_IDENTIFIER_EXPANSION='Lua '
  ...
  # Show P9K_KUBECONTEXT_CLOUD_CLUSTER if it's not empty and fall back to P9K_KUBECONTEXT_CLOUD_CLUSTER.
  ...
  typeset -g POWERLEVEL9K_AWS_SHOW_ON_COMMAND='kubectl|helm|aws|awless|cdk|terraform|pulumi|terragrunt'
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_VPN_IP_VISUAL_IDENTIFIER_EXPANSION='VPN ON '
